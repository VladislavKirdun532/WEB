// Глобальный массив для хранения данных о сотрудниках (без localStorage)
let employees = [];
...
function calculateMinutes() {
    ...
    try {
        ...
        document.getElementById('minutesResult').innerHTML = `
            С начала занятия прошло: <strong>${diffMinutes}</strong> минут.
        `;
    } catch (e) {
...
function calculateEmployeeStats(employee) {
    ...
    return { workingDays, weekendDays, salary };
}
